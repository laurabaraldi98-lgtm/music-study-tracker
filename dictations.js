const dictationDate = document.getElementById(
    "dictation-date"
);

const dictationName = document.getElementById(
    "dictation-name"
);
        ...
        function (dictation) {
            ...
            deleteButton.addEventListener(
                ...
                async function () {
                    ...
                    try {
                        await deleteDictationFromServer(
                            dictation.id
                        );
...
function formatDictationFromDatabase(
    ...
    return {
        ...
        name: dictation.name,
        youtubeLink:
            dictation.youtube_link,
        dictationTypeId:
            dictation.dictation_type_id,
        dictationTypeName,
        collection:
            dictation.collection,
        availableCategories:
